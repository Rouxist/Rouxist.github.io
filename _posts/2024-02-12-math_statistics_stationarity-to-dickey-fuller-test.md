...
- 아래는 시차에 따른 ACF 값들을 정리한 correlogram
  ...
  ![ACF correlogram](/assets/post-img/math/statistics/stationarity-to-dickey-fuller-test/correlogram.png){: width="200" }  
  (일단 [위키](https://en.wikipedia.org/wiki/Correlogram){:target=”\_blank”} 에서 퍼온 사진)
...
- $$AR(1)$$ 의 예시
  - 이자율(Ornstein–Uhlenbeck process), 이자율 스프레드, real exchange rate(실질 환율), Valuation ratios [^fn1]
...
Stationarity에 대한 테스트로, trend가 있는지를 테스트하는 것. [t-Test](https://rouxist.github.io/posts/math_statistics_t-test/){:target=”\_blank”} 를 기반으로 한다.
...
[https://datalabbit.tistory.com/117](https://datalabbit.tistory.com/117){:target=”\_blank”}  
[https://direction-f.tistory.com/65](https://direction-f.tistory.com/65){:target=”\_blank”}  
[https://www.stat.unm.edu/~ghuerta/tseries/week6_1.pdf](https://www.stat.unm.edu/~ghuerta/tseries/week6_1.pdf){:target=”\_blank”}
